  ...
  return (
    <div className='min-h-screen bg-[#fff9f6] flex flex-col justify-center items-center px-4 text-center relative overflow-hidden'>
          ...
          <FaCheckCircle  className='text-green-500 text-6xl mb-4'/>
            <h1  className='text-3xl font-bold text-gray-800 bm-2'>Order Placed!</h1>
            <p className='text-gray-600 max-w-md mb-6 '> Thank you for purchase Your order is being prepared you can track your order status in the "My Order" Section </p>
